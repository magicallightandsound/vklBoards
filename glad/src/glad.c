/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.24a0 on Wed Sep 19 16:14:58 2018.
    ...
    Commandline:
        --profile="core" --api="gl=4.3,gles2=3.2" --generator="c" --spec="gl" --no-loader --extensions="GL_OES_EGL_image,GL_OES_EGL_image_external"
    Online:
        http://glad.dav1d.de/#profile=core&language=c&specification=gl&api=gl%3D4.3&api=gles2%3D3.2&extensions=GL_OES_EGL_image&extensions=GL_OES_EGL_image_external
*/
...
static void load_GL_OES_EGL_image(GLADloadproc load) {
  // TODO(jbell): "GL_OES_EGL_image" or "GL_OES_EGL_image_external" do not seem to appear when iterating throug the
  // values of GL_EXTENSIONS. Despite this, the functions from these extensions can still be loaded successfully. Since
  // this is a generated c file, and not a submodule, I can just comment out the early exit. We should investigate why
